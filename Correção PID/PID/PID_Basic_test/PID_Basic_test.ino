...
#define rightBaseSpeed 220 // this is the speed at which the motors should spin when the robot is perfectly on the line
#define leftBaseSpeed 220  // this is the speed at which the motors should spin when the robot is perfectly on the line
  ...
  if ((error > -200)&&(error < 200));
   {
     ...
     Robot.frente(leftMotorSpeed, rightMotorSpeed); 
